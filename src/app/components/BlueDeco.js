...
export default function BlueDeco({ variant = "clouds" }) {
  if (variant === "clouds") {
    return (
      <>
        <div style={{ position:"absolute", top:"-5%", left:"-6%", width:"clamp(180px,30vw,360px)", height:"clamp(180px,30vw,360px)", borderRadius:"50%", background:"radial-gradient(circle, rgba(74,179,216,0.45) 0%, rgba(40,153,204,0.2) 50%, transparent 70%)", filter:"blur(24px)", animation:"float 8s ease-in-out infinite", pointerEvents:"none", zIndex:0 }}/>
        <div style={{ position:"absolute", bottom:"3%", right:"-4%", width:"clamp(150px,24vw,300px)", height:"clamp(150px,24vw,300px)", borderRadius:"50%", background:"radial-gradient(circle, rgba(40,153,204,0.38) 0%, transparent 70%)", filter:"blur(20px)", animation:"floatR 10s ease-in-out 2s infinite", pointerEvents:"none", zIndex:0 }}/>
        ...
        <div style={{ position:"absolute", top:"25%", right:"7%", fontSize:"clamp(1rem,2.5vw,1.6rem)", opacity:0.5, animation:"float 6s ease-in-out 1s infinite", pointerEvents:"none", zIndex:1 }}>❄️</div>
  ...
  if (variant === "balloons") {
    return (
      <>
        ...
        <div style={{ position:"absolute", top:"40%", left:"3%", fontSize:"clamp(1.2rem,2.5vw,1.8rem)", opacity:0.4, animation:"float 8s ease-in-out 1s infinite", pointerEvents:"none", zIndex:1 }}>💙</div>
        <div style={{ position:"absolute", top:"55%", right:"4%", fontSize:"clamp(1.2rem,2.5vw,1.8rem)", opacity:0.4, animation:"floatR 9s ease-in-out 2s infinite", pointerEvents:"none", zIndex:1 }}>❄️</div>
      </>
    );
  }
  ...
  if (variant === "stars") {
    return (
      <>
        ...
        <div style={{ position:"absolute", top:"45%", right:"4%", fontSize:"clamp(1.2rem,2.5vw,1.6rem)", opacity:0.4, animation:"sparkle 3s ease-in-out 0.8s infinite", pointerEvents:"none", zIndex:1 }}>❄️</div>
      </>
    );
  }
